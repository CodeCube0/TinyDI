...
container.registerInstance(ConfigToken, { apiUrl: 'https://example.com' });`,
  ...
  {
    type: 'p',
    html: 'Il terzo argomento, opzionale, è un <a href="lifetimes.html"><code>ServiceLifetime</code></a> — di default è <code>Singleton</code>.',
  },
  ...
  { type: 'code', lang: 'ts', code: 'const userService = container.resolve(UserServiceToken);' },
  {
    ...
    kind: 'warning',
    title: 'Casi limite',
    html: 'Lancia <code>ResolutionError</code> se il token non è mai stato registrato, e <code>CircularDependencyError</code> se risolverlo richiederebbe di risolvere se stesso di nuovo — vedi <a href="api-reference.html#errors">API Reference</a> per la forma esatta degli errori.',
  },
