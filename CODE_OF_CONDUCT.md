...
private report via [GitHub's report abuse form](https://github.com/contact/report-abuse)
on the repository, or, if unavailable, at `conduct@tinydi.dev`. All complaints
will be reviewed and investigated promptly and fairly.

All community leaders are obligated to respect the privacy and security of the
reporter of any incident.

> `tinydi.dev` is a placeholder domain (the project has no registered domain
> yet, see [CLAUDE.md](CLAUDE.md)); update this address once a real one
> exists.
