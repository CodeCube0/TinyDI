...
export const blocks = [
  ...
  },
  {
    ...
    rows: [
      ['Dependency discovery', 'Explicit, via factories', 'Explicit, via plain function calls'],
      [
      ...
      [
        'Runtime cost',
        'One <code>Map</code> lookup per <code>resolve()</code> call',
        'None — direct function calls',
      ],
      [
        'Concepts to learn',
        'Token, Container, ServiceLifetime',
